...
function OneDriveManager(clientId, redirectUri) {
    var ROOT_DIRECTORY = "me/skydrive",
        ...
        getDownloadUrlByFileId = function(id) {
            return "https://apis.live.net/v5.0/" + id + "/content?" + storage.getAccessToken();
        },

        getPreviewUrl = function(id){
            return  "https://apis.live.net/v5.0/" + id + "/picture?type=thumbnail&"+ storage.getAccessToken();
        },
    ...
    storage.generateUrls = function() {
        var clientId = storage.getClientId(),
            ...
            userInfoUrl = "https://apis.live.net/v5.0/me/?method=GET&interface_method=undefined&pretty=false&return_ssl_resources=false&x_http_live_library=Web%2Fchrome_5.5&suppress_redirects=true&callback=JSONP&"+accessToken,
            ...
            searchUrl = "https://apis.live.net/v5.0/me/skydrive/search?q=" + searchString + "&method=GET&interface_method=undefined&pretty=false&return_ssl_resources=false&x_http_live_library=Web%2Fchrome_5.5&suppress_redirects=true&callback=JSONP&"+accessToken;
